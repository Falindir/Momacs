tabHome = fluidPage(
  ...
  box(width = 12, 
      ...
      fluidRow(
        ...
        column(width = 4, selectInput("selectimages", "Chose image:", c())),
        
        column(width = 2,   selectInput("selectedPartitionPoint", "Partition points:", choices = c("P0"), selected = NULL, multiple = FALSE,
                                        selectize = FALSE)),
        column(width = 2, selectInput("selectedPartitionSegment", "Partition segments:", choices = c("S0"), selected = NULL, multiple = FALSE,
                                      selectize = FALSE)),
        column(width = 2,   selectInput("selectedPartitionCurve", "Partition curves:", choices = c("C0"), selected = NULL, multiple = FALSE,
                                        selectize = FALSE))
      ), 
